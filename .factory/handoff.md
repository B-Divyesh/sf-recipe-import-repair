...
No known product gaps. After push, confirm the Azure Static Web Apps deployment returns the configured static 404 with HTTP 404 and re-run the live identity/header check.
